...
<head>
    ...
    <style type="text/tailwindcss">
        @layer utilities {
            ...
            .chat-window {
                height: 60vh;
                @apply bg-ye-dark/30 backdrop-blur-sm border border-ye-muted/30 rounded-xl shadow-apple overflow-hidden;
            }
            .message-sender {
                @apply bg-ye-accent text-ye-bg text-right ml-[20%] mb-4 p-3 rounded-2xl rounded-tr-sm shadow-sm;
            }
            .message-receiver {
                @apply bg-ye-dark/80 text-white mr-[20%] mb-4 p-3 rounded-2xl rounded-tl-sm shadow-sm;
            }
            .notification {
        ...
        /* Fix untuk dark mode hover color */
        html[data-theme='dark'] .ye-btn-outline:hover {
            color: var(--bg-primary);
        }
        
        html[data-theme='light'] .ye-btn-outline:hover {
            color: var(--bg-primary);
        }
    </style>
...
<body class="h-full flex flex-col">
    <!-- Main layout for landing page - different from auth -->
